...
class Package:
    ...
    def put_belt(self, belt, new_x, new_y):
        """ This method changes some attributes of the package when it is
    ...
    def fall_package(self):
        """ This method changes the attributes fall and fall_frame of the
        package when it falls. """
        self.fall = True
    ...
    def delete(self, board):
        """ This method deletes the package from the list, if it is at the
        last position of the belt. """
        if self.belt == 0:
